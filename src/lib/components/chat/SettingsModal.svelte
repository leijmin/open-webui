	...
	const allSettings: SettingsTab[] = [
		{
			id: 'general',
			title: '常规',
			keywords: ['常规', '站点', '主题', '通知', '语言', '系统提示词']
		},
		{
			id: 'interface',
			title: '界面',
			keywords: ['界面', '聊天', '布局', '显示', '默认模型', '输入', '通知', '宽屏']
		},
		{
			id: 'connections',
			title: '连接',
			keywords: ['连接', '接口', '模型接口', '服务地址']
		},
		{
			id: 'tools',
			title: '工具',
			keywords: ['工具', '集成', '外部服务', '终端']
		},

		{
			id: 'personalization',
			title: '个性化',
			keywords: ['个性化', '偏好', '记忆', '资料']
		},
		{
			id: 'audio',
			title: '语音',
			keywords: ['语音', '音频', '朗读', '识别', '播放']
		},
		{
			id: 'data_controls',
			title: '数据',
			keywords: ['数据', '聊天记录', '导入', '导出', '归档']
		},
		{
			id: 'account',
			title: '账号',
			keywords: ['账号', '密码', '头像', '密钥', '通知']
		},
		{
			id: 'about',
			title: '关于',
			keywords: ['关于', '版本', '站点', '帮助', '管理员']
		}
	];
