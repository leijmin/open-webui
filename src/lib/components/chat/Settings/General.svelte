...
<div class="flex flex-col h-full justify-between text-sm" id="tab-general">
	<div class="  overflow-y-scroll max-h-[28rem] md:max-h-full">
		<div class="">
			<div class=" mb-1 text-sm font-medium">{$i18n.t('站点设置')}</div>
			...
			<div class=" flex w-full justify-between">
				<div class=" self-center text-xs font-medium">{$i18n.t('默认语言')}</div>
				<div class=" self-center text-xs text-gray-500 dark:text-gray-400">简体中文</div>
			</div>
